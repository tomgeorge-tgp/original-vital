...
import "./style/bp2_Pop.css";
import PropTypes from 'prop-types'

function Bp2(props){
  return (
    <>
      <div className="bp2-container">
        <div className="bp2-container1">
          <div className="bp2-html-node">
            {/* <span
          ...
          <button className="bp2-button button">{props.stop_button}</button>
        </div>
      </div>
