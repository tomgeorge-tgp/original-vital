...
import BloodPressureFetch from "../components/BloodPressureStop";
import BloodPressureReading from "../components/BpReadingsPop";
...
const BloodPressurepopup = (props) => {
  ...
  const [popUpSequence, setPopupSequence] = useState("BP_START");
        ...
        else if (popUpSequence === "BP_FETCH") return (<BloodPressureFetch setinitateTestPopUp={"wear device and press \"start\"."} data={bpData} onExitClick={props.onExitClick} onContinueClick={props.onContinueClick}  />);
